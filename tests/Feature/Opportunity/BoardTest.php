...
it('should render the board page', function () {
...
// it('should update opportunities', function () {
//     $opp1 = Opportunity::factory()->create(['status' => 'open', 'sort_order' => 1]);
//     $opp2 = Opportunity::factory()->create(['status' => 'open', 'sort_order' => 2]);
//     $opp3 = Opportunity::factory()->create(['status' => 'won', 'sort_order' => 3]);
//     $opp4 = Opportunity::factory()->create(['status' => 'won', 'sort_order' => 4]);
//     $opp5 = Opportunity::factory()->create(['status' => 'lost', 'sort_order' => 5]);
//     $opp6 = Opportunity::factory()->create(['status' => 'lost', 'sort_order' => 6]);
